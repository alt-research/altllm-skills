...
| `altllm-portal-payments` | `topup-crypto`, `payment-status`, `pay-payment-link` | Includes direct-payment guardrails, supported pay currencies, and credit top-up discount-code metadata |
